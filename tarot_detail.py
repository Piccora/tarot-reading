...
instructions_1 = "\nTo start with, you will choose a question among these fives:\n"
...
cards_positions_to_meaning = {
    ...
    "II_1": "It seems that your partner in this relationship still has a lot of worries and thoughts, they have not really opened their heart to share all the secrets with the other person. They are careful and wary of taking things passively, developing an intense, emotional love relationship is not an option for them right now. Maybe it's because this is the first time they've tasted love, or maybe they've had some stumbles in the past, but now they're more careful, more alert when opening their heart.",
    "II_2": "The relationship between the two of you has spiritual connections, beyond the present tangible world. You spend time with each other, use intuition to understand each other better and feel deep and sincere love from the heart. Gradually, secrets about each other will be revealed and you will have the opportunity to understand more about each other, both advantages and disadvantages of separate personalities.",
    ...
    "III_1": "Your partner feels nurtured and pampered in this relationship or they play the role of protecting, nurturing, and sending love to the relationship between the two of you. Either way, this relationship is still giving them abundant, intense emotions. They feel cherished and appreciated and have great faith in the future of the relationship.",
    "III_2": "This relationship is in the stage of blooming the first flowers of love, you spend more time together and with every minute you spend together, the chemical reactions between you two become more intense, the more romantic. The two of you enjoy traveling together, dating, caring, and chatting together. Hugs, kisses, and holding hands are like a rich spice for the relationship between two people.",
    ...
    "V_1": "Your partner values tradition in developing love relationships and do not like concepts that are out of the way or too new. In addition to love, the development of an academic and career path is still an important thing in their life. They want to keep the good values ​​of a sincere, romantic, and warm love, they also hope to find the same beliefs from the other side.",
    "V_2": "The two of you met or fell in love in a highly academic environment, be it school, work, or company, or were introduced through friends, colleagues, and people you are close to. Both of them have similar beliefs on many topics in life, be it religious beliefs or any other outlook on life. For some people who have drawn this card, your relationship may be about to move to a new stage of greater commitment. For example, from the stage of getting to know each other to the stage of developing an intimate love relationship, couples who have known each other for a while, you can prepare to get engaged or get married.",
    ...
    "VII_1": "Your partner is brave in the face of love, ready to defy all, and overcome all challenges to develop this relationship. The ego in their love is also very sure, straightforward, and dignified. If they are intending to express their feelings to you, this is a great opportunity for them to do so.",
    "VII_2": 'You are becoming the master of your own "game", the results you have achieved in this relationship so far may be challenged by the universe, be brave, and speak frankly. Talk to each other about things you don\'t like. Controlling your ego and keeping a peaceful, cautious attitude in the relationship is also very important to help the two of you go further in love.',
    ...
    "VIII_1": "In love, your partner is solid and reliable, being strong spiritual support for the other person. The patience and compassion in them nurture and develop this relationship, they also always burn a fire of enthusiasm and precious sincerity for the person they love. It seems that whatever mistakes the other person made in the past, they are willing to forgive them, accept to learn how to understand and tolerate them.",
    "VIII_2": "The bond between the two of you is getting stronger and stronger, you understand, tolerate, and love each other. Although you always want to spend time together, you are still very patient, waiting and giving each other space. Compassion and forgiveness have made the relationship between two people very strong, reducing heated arguments or unreasonable jealousy.",
    ...
    "IX_1": "Your partner is looking for quiet, separate spaces for themselves. They alone turn back, and dig deep into the roots of this relationship, about what they want and need in the relationship. At this stage, they are a bit lost and tend to develop a more personal inner self, close their heart and share with the other person.",
    "IX_2": "The two of you seem to have separate plans in life, you are standing at different crossroads in life. The time spent together is getting less and less, perhaps because you still have problems and doubts in your heart that you want to dig deep to find out for yourself. This stage is a stage toward personal development from the depths of the soul, so the relationship between the two will slow down a bit.",
    ...
    "XI_1": "This is the right time for your partner to pursue clear decisions and cut off the tangles that they have had to go through in love. The Justice card upholds fairness and decisiveness, reclaiming and protecting their rights. It could be the end of a toxic relationship, the decision to dedicate themselves fully to the relationship, or the period when they accept the consequences of their decisions and actions in the past.",
    "XI_2": "This relationship is demanding clarity from both sides. The balance of responsibilities and development roles should be balanced between the two sides, you should openly and honestly express your views to each other, and don't let out-of-the-way gossip affect the development of the relationship. relationship. If you are looking forward to a new stage of development such as marriage, engagement, etc., then you need to make a clear plan right now.",
    ...
    "XII_1": "Your partner is quite passive in developing this relationship, they seem to want to let love be nurtured and blossomed most naturally. They want to take a step back to accept, see the relationship between two people from different angles, more slowly, more carefully than before. Maybe they sacrificed their own interests for the other person, accepting the reality and putting the other person first.",
    ...
    "XIII_1": "Your partner is probably thinking of an end and release for both of you. They feel a part of their inner self that is crying out for the transformation and rebirth of a new them, perhaps the relationship itself being a hindrance to that stage of incarnation. They want to get out of the stuffy, secretive phase of the relationship and onto a new path, a newer direction.",
    "XIII_2": "This relationship may no longer bring you the same joy, happiness, and benefits as the original. Both people want to find their own paths, and the cessation of change is necessary for both sides. Maybe this is not the right time for you to continue this relationship.",
    "XIV_0": "You appreciate the balance between all problems in life, conflicts and arguments are things you avoid and control during this period as they will upset your order of life. You want to gently heal your soul, connect with your partner with all your heart, and reconcile your differences.",
    "XIV_1": "Your partner appreciates the balance between all problems in life, conflicts and arguments are things they avoid and control during this period as they will upset your order of life. They want to gently heal their soul, connect with you with all their heart, and reconcile their differences.",
    "XIV_2": "This relationship is in a very peaceful and harmonious period, you respect each other, and live in harmony and peace. The balance of all factors in life is also what you value first because even though it is developing a love relationship, money, finance, and health are still important foundations for maintaining a relationship.",
    ...
    "XV_1": "Your partner is feeling constrained, and trapped in this very toxic relationship. The other party may be too controlling and take over every action and decision they make. If they let this situation go on for longer, their mental and physical health will become more and more damaged.",
    "XV_2": "This relationship is developing in a rather toxic and unbalanced direction. The physical and mental constraints will weigh even more on your shoulders. You feel trapped, tired, and feel like you're being taken advantage of in your own relationship.",
    "XVI_0": "This relationship is developing in a rather toxic and unbalanced direction. The physical and mental constraints will weigh even more on your shoulders. You feel trapped, tired, and feel like you're being taken advantage of in your own relationship.",
    "XVI_1": "This relationship is developing in a rather toxic and unbalanced direction. The physical and mental constraints will weigh even more on your partner's shoulders. They feel trapped and tired, and feel like they're being taken advantage of in their own relationship.",
    "XVI_2": "This relationship seems to have been very solid and long-lasting, but because of some unexpected problems, cracks have occurred.",
    "XVII_0": "You gradually open up to the other person, ready to share everything. You are comfortable spending time with them because for you they are like a cure-all to ease your inner fatigue.",
    "XVII_1": "Your partner gradually opens up to you, ready to share everything. They are comfortable spending time with you because for them you are like a cure-all to ease their inner fatigue.",
    "XVII_2": "If in the past the relationship was having some problems and difficulties in connecting between the two of you, in the coming time, you will gradually feel the positive rays flashing at the end of the road. You will gradually have faith and hope in the development of this relationship again.",
    "XVIII_0": "You are in a vague, indeterminate state. It seems that you are no longer sure about the feelings and emotions you have for this relationship. You close your heart, and sink into your inner self, struggling to find the way out.",
    "XVIII_1": "Your partner is in a vague, indeterminate state. It seems that they are no longer sure about the feelings and emotions they have for this relationship. They close their heart, and sink into their inner self, struggling to find the way out.",
    "XVIII_2": "This relationship is in a state of confusion and ambiguity, there doesn't seem to be a clear outcome about the future of the relationship between the two. This hazy and unknown state will continue to engulf the relationship for an even longer time.",
    "XIX_0": "You clearly know your direction and goals for this relationship in the upcoming time. Everything positive and warm is overflowing the connection between the two. It seems that you will be more proactive in developing this relationship in the future.",
    "XIX_1": "Your partner clearly knows their direction and goals for this relationship in the upcoming time. Everything positive and warm is overflowing the connection between the two. It seems that they will be more proactive in developing this relationship in the future.",
    "XIX_2": "It seems like you are about to experience more positive and wonderful things in love together, and your relationship will continue to take faster and bolder strides. The two of you are confident, liberal and enthusiastic in every moment spent together.",
    "XX_0": "You re-evaluate your role in this relationship so far. You are strict and serious about your mistakes, but sometimes forgiveness is also a very important factor in love.",
    "XX_1": "Your partner re-evaluates their role in this relationship so far. They are strict and serious about their mistakes, but sometimes forgiveness is also a very important factor in love.",
    "XX_2": "You take a moment to review the relationship between the two of you, it seems that you are about to make a very important decision regarding the future of the relationship. Or maybe one of you has made a mistake that makes the connection between the two of you need to be seriously reviewed.",
    "XXI_0": "The results you are looking forward to regarding this relationship are about to be revealed to you. You may feel a bit overwhelmed because of the upcoming period, those answers and results will come continuously and quickly.",
    "XXI_1": "The results your partner is looking forward to regarding this relationship are about to be revealed to them. They may feel a bit overwhelmed because of the upcoming period, those answers and results will come continuously and quickly.",
    "XXI_2": "The two of you seem to be looking forward to a happy ending to this relationship, be it a marriage proposal, a commitment, or even a lavish and romantic wedding. Don't worry because soon, the two of you will experience the best things in love together.",
}
