...
instructions_3 = "\nDeveloper note: We have only implemented readings for the major arcana currently. Please only choose from the major arcana of your tarot deck.\n"
...
cards_positions_to_meaning = {
    ...
    "II_1": "It seems that your partner in this relationship still have a lot of worries and thoughts, they have not really opened their heart to share all the secrets with the other person. They are careful, and wary of taking things passively, developing an intense, emotional love relationship is not an option for them right now. Maybe it's because this is the first time they've tasted love, or maybe they've had some stumbles in the past, but now they're more careful, more alert when opening their heart.",
...
# for value in cards_positions_to_meaning.values():
#     print(value)